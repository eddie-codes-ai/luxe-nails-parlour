      ...
      <div style={{ maxWidth: "700px", margin: "0 auto", padding: "48px 40px" }}>
        ...
        <div style={{
          ...
          <p style={{ fontSize: "13px", color: "rgba(45,36,36,0.45)", marginBottom: "24px" }}>
            Categories appear in the product form dropdown and as filter tabs on the shop page.
          </p>
        ...
        {loading ? (
          ...
          <div style={{
            ...
            <p style={{ fontSize: "14px", color: "rgba(45,36,36,0.4)" }}>No categories yet. Add your first one above!</p>
          </div>
        ) : (
            ...
            {categories.map(cat => (
              <div key={cat.id} style={{
                ...
                <div style={{ display: "flex", alignItems: "center", gap: "12px" }}>
                  <div style={{
                    width: "8px", height: "8px", borderRadius: "50%", background: "#C5A358", flexShrink: 0,
                  }} />
                  <span style={{ fontSize: "14px", color: "#2D2424", fontWeight: 500 }}>{cat.name}</span>
                </div>
                <button
                  type="button"
